...
public class ApiController {
	...
	public record IncidentInfo(String title, String description, LocalDate happenedOn, IncidentOrigin origin,
			IncidentStatus status, List<IncidentUpdate> updates) {

		static IncidentInfo fromIncident(Incident incident) {
			return new IncidentInfo(incident.getTitle(), incident.getDescription(), incident.getHappenedOn(),
					incident.getOrigin(), incident.getStatus(),
